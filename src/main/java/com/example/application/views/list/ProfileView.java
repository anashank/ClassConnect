...
public class ProfileView extends VerticalLayout {
    ...
    //private UserDetailsServiceImpl databaseService = new UserDetailsServiceImpl;

    public ProfileView(UserDetailsServiceImpl databaseService) {
        ...
        add(title, horizontalLayout, Lastname, Email, school, grade, gridLabel, example, edit);
    }
